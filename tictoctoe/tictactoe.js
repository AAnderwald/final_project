...
const spaces = [null, null, null, null, null, null, null, null, null];              //each box
const O_TEXT = "O";
const X_TEXT = "X";
...
const hasPlayerWon = (player) =>
{
  ...
  if (spaces[8] === player)
  {
    ...
    else if (spaces[7] === player && spaces[6] === player) {
...
restartBtn.addEventListener("click", () => {
  ...
  playText.innerHTML = `Let's play a round!`;
